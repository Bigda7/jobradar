...
async def test_robota_ua_source_uses_platform_pagination_and_detail_cache() -> None:
    ...
    assert requested_paths.count("/zapros/python-remote/ukraine/params;page=2") == 2
    assert requested_paths.count("/company123/vacancy111") == 1
    assert requested_paths.count("/company456/vacancy222") == 1
